...
<div class="accountFlex">
    ...
    <form action="/modifier-mon-compte" method="post" id="logForm" >
        ...
        <br>
        <input type="submit" value="Modifier" name="updateInfos"><!-- button confirmer la modification  -->

        <button id="openModalBtn"><a href="#delete">Supprimer ton compte</a></button><!-- button avec lien qui ouvre le modal de suppression de compte  -->
    </form>
